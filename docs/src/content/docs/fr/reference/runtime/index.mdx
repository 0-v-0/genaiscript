...
* [@genaiscript/plugin-ast-grep](../../../reference/reference/scripts/ast-grep/)
* [@genaiscript/plugin-mermaid](../../../reference/reference/runtime/plugin-mermaid/)
* [@genaiscript/plugin-z3](../../../reference/reference/scripts/z3/)
