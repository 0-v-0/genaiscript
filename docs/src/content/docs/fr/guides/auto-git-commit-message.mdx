...
Le script fonctionne comme un script d'automatisation standard pour Node.js et utilise [runPrompt](/genaiscript/reference/scripts/inline-prompts) pour effectuer des appels au LLM et demander à l'utilisateur de confirmer le texte généré.

:::tip
Vous pouvez consulter l'exemple [Git Commit Message](/genaiscript/samples/gcm) pour un script complet, prêt à l'emploi.
:::
...
Vous pouvez exécuter ce script en utilisant le [CLI](/genaiscript/reference/cli).
