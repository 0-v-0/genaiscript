...
:::note
Vous aurez besoin d'une [clé API Bing Web Search](/genaiscript/reference/scripts/web-search) pour utiliser `webSearch`.
:::
...
<Steps>
  ...
  3. Utilisez la fonction [`webSearch`](/genaiscript/reference/scripts/web-search/) pour
  ...
  4. `webSearch` renvoie une liste d'URL. Utilisez [`fetchText`](/genaiscript/reference/scripts/fetch/)
