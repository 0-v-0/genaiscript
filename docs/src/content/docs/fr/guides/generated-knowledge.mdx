...
Cette technique peut être réalisée en utilisant [runPrompt](/genaiscript/reference/scripts/inline-prompts) pour exécuter une requête au LLM et l'utiliser dans l'invite finale.
