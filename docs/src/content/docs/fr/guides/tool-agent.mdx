...
En utilisant les [outils (anciennement fonctions)](/genaiscript/reference/scripts/tools),
...
La question arithmétique peut être déclarée comme un [paramètre de script](/genaiscript/reference/scripts/variables) à utiliser dans le script de l'agent.
...
L'invite système [system.math](/genaiscript/reference/scripts/system#systemmath)
