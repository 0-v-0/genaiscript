...
Nous traitons chaque fichier séparément pour ne pas surcharger le contexte de tokens et pour maintenir la concentration de l'IA. Nous pouvons utiliser des [prompts en ligne](/genaiscript/reference/scripts/inline-prompts) pour effectuer des requêtes internes.
