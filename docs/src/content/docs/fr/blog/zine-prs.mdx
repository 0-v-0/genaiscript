...
["Zine"](https://en.wikipedia.org/wiki/Zine) est une forme d'art graphique populaire qui combine texte et images pour raconter une histoire. Peut-on demander au LLM de générer un zine à partir d'un diff de pull request ? _voix robotique hors ligne : Oui, nous le pouvons_.
