...
<CardGrid stagger>
  ...
  <Card title="Write your first script" icon="pencil">
    Suivez [Getting Started](../../getting-started/your-first-genai-script/) pour écrire votre premier script.
  </Card>

  <Card title="Read the docs" icon="open-book">
    Apprenez-en davantage sur GenAIScript dans la [Référence Scripting](../../reference/).
  </Card>
</CardGrid>
...
<CardGrid>
  <Card title="Stylized JavaScript" icon="seti:javascript">
    Syntaxe minimale pour construire des prompts en utilisant [JavaScript](../../reference/scripts/) ou [TypeScript](../../reference/scripts/typescript/).
  ...
  <Card title="Fast Development Loop" icon="rocket">
    Éditez, [Déboguez](../../getting-started/debugging-scripts/), [Exécutez](../../getting-started/running-scripts/), [Testez](../../getting-started/testing-scripts/) vos scripts dans [Visual Studio Code](../../getting-started/installation/) ou avec une [console de commande](../../getting-started/installation/).

    <Image src={debuggerSrc} alt={debuggerAlt} loading="lazy" />
  </Card>

  <Card title="LLM Tools" icon="setting">
    Enregistrez des fonctions JavaScript comme [outils LLM](../../reference/scripts/tools/) (avec fallback pour les modèles qui ne supportent pas les outils).
  ...
  <Card title="MCP Client" icon="setting">
    Utilisez des [outils](https://modelcontextprotocol.io/docs/concepts/tools) exposés dans des [Serveurs de Fournisseurs de Contexte de Modèle](../../reference/scripts/mcp-tools/).
  ...
  <Card title="MCP Server" icon="setting">
    Chaque script est un [Outil Fournisseur de Contexte de Modèle](../../reference/scripts/mcp-server/).
  ...
  <Card title="Data Schemas" icon="list-format">
    Définissez, validez, réparez des données en utilisant des [schémas](../../reference/scripts/schemas/).
  ...
  <Card title="Ingest text from PDFs, DOCX, ..." icon="seti:pdf">
    Manipulez [des PDFs](../../reference/scripts/pdf/), [des DOCX](../../reference/scripts/docx/), ...
  ...
  <Card title="Ingest tables from CSV, XLSX, .." icon="seti:pdf">
    Manipulez des données tabulaires provenant de [CSV](../../reference/scripts/csv/), [XLSX](../../reference/scripts/xlsx/), ...
  ...
  <Card title="Speech To Text" icon="seti:microphone">
    Transcrivez automatiquement des audios ou vidéos en utilisant [OpenAI](../../configuration/openai/) ou [d'autres solutions](../../configuration/whisperasr/).
  ...
  <Card title="File search" icon="document">
    Effectuez des recherches Grep ou Fuzzy dans des [fichiers](../../reference/scripts/files/).
  ...
  <Card title="Web search" icon="magnifier">
    [Faites des recherches Web](../../reference/scripts/web-search/) en utilisant Bing ou Tavily.
  ...
  <Card title="Browser automation" icon="approve-check-circle">
    Naviguez et scrappez le web avec [Playwright](../../reference/scripts/browser/).
  ...
  <Card title="RAG built-in" icon="magnifier">
    [Recherche vectorielle intégrée](../../reference/scripts/vector-search/) en utilisant une base de données locale ou [Azure AI Search](https://learn.microsoft.com/en-us/azure/search/search-what-is-azure-search).
  ...
  <Card title="Safety First!" icon="seti:lock">
    GenAIScript offre des prompts systèmes intégrés pour une IA Responsable ainsi qu'un support de Validation de Sécurité de Contenu Azure pour valider la [sécurité du contenu](../../reference/scripts/content-safety/).
  ...
  <Card title="GitHub Models and GitHub Copilot" icon="github">
    Exécutez des modèles via GitHub en utilisant [GitHub Models](../../configuration/github/) ou [GitHub Copilot](../../configuration/github-copilot-chat/).
  ...
  <Card title="Azure AI Foundry, Google, Anthropic, Amazon, Alibaba, ..." icon="rocket">
    Exécutez des modèles issus de [Azure AI Foundry](https://ai.azure.com/), [Google](https://aistudio.google.com/), [Anthropic](https://www.anthropic.com/), [Alibaba](https://www.alibaba.com/), et bien d'autres. Consultez [Configuration](../../getting-started/configuration/).
  ...
  <Card title="Local Models" icon="laptop">
    Exécutez vos scripts avec des [modèles Open Source](../../getting-started/configuration/), tels que [Phi-3](https://azure.microsoft.com/en-us/blog/introducing-phi-3-redefining-whats-possible-with-slms/), en utilisant [Ollama](https://ollama.com/), [LocalAI](https://localai.io/), ...
  ...
  <Card title="Containers" icon="seti:docker">
    Exécutez du code dans des [conteneurs Docker](../../reference/scripts/container/).
  ...
  <Card title="LLM Composition" icon="external">
    [Exécutez des LLMs](../../reference/scripts/inline-prompts/) pour construire vos prompts LLM.
  ...
  <Card title="Generate Images" icon="sun">
    [Générez des images](../../reference/scripts/image-generation/) en utilisant OpenAI DALL-E ou autres outils.
  ...
  <Card title="Pluggable Secret Scanning" icon="seti:license">
    Analysez vos discussions pour détecter la présence de secrets en utilisant le [scanning de secrets](../../reference/scripts/secret-scanning/).
  ...
  <Card title="Automate with CLI" icon="github">
    Automatisez avec le [CLI](../../reference/cli/), intégrez des rapports à votre pipeline CI/CD.
  ...
  <Card title="Pull Request Reviews" icon="comment">
    Intégrez des [vérifications Pull Requests](../../reference/cli/run/#pull-requests/) via commentaires, revues ou mises à jour de descriptions. Prend en charge GitHub Actions et les pipelines Azure DevOps.
  ...
  <Card title="Tests and Evals" icon="star">
    Construisez des prompts fiables en utilisant des [tests et évaluations](../../reference/scripts/tests/) grâce à [promptfoo](https://promptfoo.dev/).
