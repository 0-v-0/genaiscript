...
- [@genaiscript/plugin-ast-grep](/genaiscript/reference/scripts/ast-grep/)
- [@genaiscript/plugin-mermaid](/genaiscript/reference/runtime/plugin-mermaid/)
- [@genaiscript/plugin-z3](/genaiscript/reference/scripts/z3/)
