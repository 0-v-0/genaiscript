 ...
 */
export async function callExpander(prj, r, ev, trace, options, installGlobally) {
...
export async function expandTemplate(prj, template, options, env) {
    ...
    try {
        ...
        for (let i = 0; i < systems.length; ++i) {
            ...
            const sysr = await callExpander(prj, system, mergeEnvVarsWithSystem(env, systemId), trace, options, false);
            if (sysr.images)
