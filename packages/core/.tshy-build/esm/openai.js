...
export const OpenAIChatCompletion = async (req, cfg, options, trace) => {
    const { requestOptions, partialCb, retry, retryDelay, maxDelay, cancellationToken, inner } = options;
