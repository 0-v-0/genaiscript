...
export async function createParsers(options) {
    ...
    return Object.freeze({
        ...
        XML: (text, options) => {
            ...
            return tryValidateJSONWithSchema(XMLTryParse(filenameOrFileToContent(text), defaultValue, rest), options);
        },
        ...
        HTMLToText: (text, options) => HTMLToText(filenameOrFileToContent(text), {
            ...(options || {}),
            trace,
            cancellationToken,
        }),
        HTMLToMarkdown: (text, options) => HTMLToMarkdown(filenameOrFileToContent(text), {
            ...(options || {}),
            trace,
            cancellationToken,
        }),
