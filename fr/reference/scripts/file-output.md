...
Vous pouvez enregistrer un callback pour manipuler de manière programmatique les fichiers générés
à l’aide de [defOutputProcessor](../../../reference/reference/scripts/custom-output/).
